...
const Faq = () => {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer:
        "Carter (B2B ad-tech) — redesigned the activation funnel and built a component system adopted across 12 teams (campaign abandonment down 68% from a 27% baseline, measured over ~6 months post-rollout). Atlas (veterinary healthcare) — unified 130–150 clinic sites under one design system and designed a no-code site builder. GoDiverse (SaaS) — AI-assisted 1-page builder. Research → interaction → UI → shipped on each.",
    },
  ];
